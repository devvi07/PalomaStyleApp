        ...
        fetch("https://pqt-calva-ws.onrender.com/api/articulos", {
            ...
            if (result.codigo == 200) {
                ...
                if (result.data && result.data.length > 0) {
                    const oKids = result.data.filter((item: any) => item.clasif == 'Kids');
                    console.log("🚀 ~ getData ~ oKids:", oKids)
                    setData(oKids);
                    setLoading(true);
                } else {
                    setData([]);
...

                                    {
                                        data.length > 0 ?
                                            ...
                                            <View style={{ flex: 1, justifyContent: 'center' }}>
                                                <Text style={{ textAlign: 'center', color: '#ff9887', fontSize: 17, fontWeight: '500' }}>No existen productos para niños</Text>
                                            </View>
                                    }
